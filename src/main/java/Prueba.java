...
import java.util.ArrayList;
    public class Prueba {
        ...
        public double eficacia(Movimiento movimiento, Pokemon defensivo) {
                ...
                if (movimiento.getTipo1().equals(Tipo1.NORMAL)) {
                ...
                } else if (movimiento.getTipo1().equals(Tipo1.PLANTA)) {
                    ...
                    if ((defensivo.getTipo1().equals(Tipo1.PLANTA) || defensivo.getTipo1().equals(Tipo1.BICHO) || defensivo.getTipo2().equals(Tipo2.BICHO) || defensivo.getTipo2().equals(Tipo2.PLANTA))) {
                        eficacia = 0.5;
                    }

                    if ((defensivo.getTipo1().equals(Tipo1.PLANTA)||  defensivo.getTipo2().equals(Tipo2.BICHO) ) && (defensivo.getTipo1().equals(Tipo1.BICHO) || defensivo.getTipo2().equals(Tipo2.PLANTA))) {
                        eficacia = 0.25;
                    }
                    if (defensivo.getTipo1().equals(Tipo1.VOLADOR) || defensivo.getTipo1().equals(Tipo2.VOLADOR)) {
                        eficacia = 0;
